...
public class MainController {
    ...
    // 채팅방 목록
    public static LinkedList<Room> chatingRoomList = new LinkedList<>();
    ...
    // 방 입장하기
    public boolean enterChatingRoom(Room chatingRoom, String nickname) {
    ...
    public ResponseEntity<?> chatingRoomList() {
        return new ResponseEntity<LinkedList<Room>>(chatingRoomList, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> EnterChatingRoom(String roomNumber, String nickname){
        ...
        // 방 번호로 방 찾기
        Room chatingRoom = findRoom(roomNumber);
